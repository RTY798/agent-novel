...
6. 情感爆点+手法预选：【本章情感爆点】一句话定义。预选手法：五感(具体选哪几个感官)、内心对比/侧面烘托(选其一)、象征物品(如有)
```
...
- **4e**：金手指覆盖率+情感爆点检测（30秒·PASS/FAIL）。检查项：①情感爆点是否在L0意图卡中明确标注？②是否组合使用了≥3种感官（不能全是视觉）+ 至少1个角色专属动作（咬笔/转打火机/敲床单等）？③是否使用了≥1种内心对比或侧面烘托？④如有NPC死亡，是否满足铁律①②③④？未达标→退回修改（与4a同等待遇，3轮熔断）。
